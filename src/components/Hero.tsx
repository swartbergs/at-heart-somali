...
export const Hero = () => {
  return <section className="relative w-full h-[70vh] min-h-[550px] flex items-center justify-start overflow-hidden">
      {/* Hero Image */}
      <img src={heroCat} alt="En vacker somalikatt med gyllenbrun päls och intensiva bernstänsfärgade ögon" className="absolute inset-0 w-full h-full object-cover object-center" />
